...
// Remove getImagePath import - we'll resolve paths in components

// Extended interfaces for comprehensive conference data
...
export interface Conference {
  ...
  heroSubtitle?: string;
  heroBadgeText?: string; // For the animated badge text
  conferenceOverview?: string; // For the conference overview section
  conferencepara1?: string; // For the conference paragraph section
  conferencepara2?: string; // For the conference paragraph section
  expertSpeakers?: string; // For the expert speakers section
  sessions?: string; // For the sessions section
  chairperson?: string; // For the chairperson section
  chairpersonDescription?: string; // For the chairperson description section
  charipersonheader?: string; // For the chairperson header section
  chairpersonpara1?: string; // For the chairperson paragraph section
  chairpersonpara2?: string; // For the chairperson paragraph section
  abstractkeytopics?: string[]; // For the abstract key topics section
  speakerheader?: string; // For the speaker header section
  pricingTiers?: PricingTier[];
  schedule?: ScheduleDay[];
  publishingPartners?: PublishingPartner[];
...
export const getConferenceWithDetails = (id: string): Conference | undefined => {
  ...
  // Ensure all required extended data is present
  return {
    ...conference,
    speakers: conference.speakers || [],
    venueImages: conference.venueImages || [],
    pricingTiers: conference.pricingTiers || [],
    schedule: conference.schedule || [],
    // expertSpeakers: conference.expertSpeakers || '',
    // sessions: conference.sessions || '',
    // chairperson: conference.chairperson || '',
    // chairpersonDescription: conference.chairpersonDescription || '',
    // charipersonheader: conference.charipersonheader || '',
    // chairpersonpara1: conference.chairpersonpara1 || '',
    // chairpersonpara2: conference.chairpersonpara2 || '',
    abstractkeytopics: conference.abstractkeytopics || [],
    // speakerheader: conference.speakerheader || '',
    publishingPartners: conference.publishingPartners || [],
