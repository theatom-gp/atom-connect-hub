...
const Neurology = () => {
  ...
  const scheduleData = [
    {
      ...
      sessions: [
        ...
        { time: "16:15-18:00", activity: "Neurology Sessions" }
      ]
    },
    {
      day: "Day 2", 
      ...
      sessions: [
        ...
        { time: "11:30-11:45", activity: "Networking Break" },
        { time: "11:45-13:45", activity: "Neurology Sessions" },
        { time: "13:45-14:30", activity: "Networking Lunch Break" },
        { time: "14:30-16:30", activity: "Neurology Sessions" },
        { time: "16:30-16:45", activity: "Networking Break" },
        { time: "16:45-18:30", activity: "Neurology Sessions" },
    ...
    },
    {
      ...
      sessions: [
        { time: "09:00-11:30", activity: "Neurology Sessions" },
        { time: "11:30-11:45", activity: "Networking Break" },
        { time: "11:45-13:45", activity: "Neurology Sessions" },
        { time: "13:45-14:30", activity: "Networking Lunch Break" },
        { time: "14:30-16:30", activity: "Neurology Sessions" },
  ...
  const publishingPartners = [
    { 
      name: "Neurology International", 
      description: "Leading Neurology Journal", 
    ...
    { 
      name: "Journal of Neurology Sciences", 
      description: "Academic Neurology Research", 
    ...
    { 
      ...
      description: "Neurology Research Database", 
    ...
    { 
      name: "International Journal of Neurology", 
      description: "Neurology Research", 
  ...
  const mediaPartners = [
    { 
      name: "Neurology Magazine", 
      description: "Neurology News", 
    ...
    { 
      name: "Neurology Investigation", 
      description: "Neurology Magazine", 
    ...
    { 
      name: "Neurology Today", 
      description: "Neurology Research Publication", 
    ...
    { 
      name: "Neurology Research Network", 
      description: "Neurology Research News", 
          ...
          <div className="text-center">
            ...
            <div className="inline-block animate-[staggerUp_0.8s_ease-out_0.2s_both]">
              <div className="group relative px-8 py-4 bg-white/5 backdrop-blur-xl border border-white/10 text-white rounded-full text-sm font-medium mb-12 transition-all duration-500 hover:bg-white/10 hover:border-white/20 hover:scale-105">
                ...
                <span className="relative inline-flex items-center gap-3">
                  ...
                  <span className="tracking-wider uppercase">Neurology • Research • Disorders</span>
                  <div className="flex items-center gap-1">
                ...
                <div className="relative overflow-hidden bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 transition-all duration-700 hover:bg-white/8 hover:border-white/20 hover:scale-105 hover:shadow-2xl hover:shadow-primary/10 p-6">
                  ...
                  <div className="relative flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xl font-semibold text-white">March 25-27, 2026</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in animation-delay-1200">
              ...
              <Button 
                ...
                onClick={() => isEarlyBird && navigate('/registration?conference=neurology')}
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6">
                Advancing <span className="text-primary">Neurology and Neurological Disorders</span> Through Research
              </h2>
              
              <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                Join the most influential neurology and neurological disorders conference of 2025, where cutting-edge research meets practical applications. Connect with neurology and neurological disorders experts, explore breakthrough technologies, and discover solutions that will define the future of neurology and neurological disorders.
              </p>
              
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                From neurology and neurological disorders research to neurology and neurological disorders applications, this three-day immersive experience brings together leading neurology and neurological disorders experts, researchers, and professionals from across the globe to share insights, forge partnerships, and accelerate neurology and neurological disorders innovation.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <blockquote className="text-muted-foreground text-lg leading-relaxed mb-6 italic">
                "Neurology and neurological disorders is the bridge between science and human health. The International Experts Summit on Neurology and Neurological Disorders 2026 represents a unique opportunity to witness the convergence of brilliant minds and revolutionary techniques in neurology and neurological disorders."
              </blockquote>
              
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                As we stand at the forefront of neurology and neurological disorders innovation, this conference serves as a catalyst for meaningful collaboration and groundbreaking discoveries. Join us in San Francisco as we explore the technologies and methodologies that will shape the future of neurology and neurological disorders and create lasting impact across the neurology and neurological disorders system worldwide.
              </p>
              
              <div className="mb-8">
                <p className="font-semibold text-foreground">Dr. Carlos Mendes</p>
                <p className="text-muted-foreground">Conference Chair & Director of Neurology and Neurological Disorders, Portuguese National Institute of Neurology and Neurological Disorders</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-secondary/10 rounded-lg p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Share your research and insights with the global neurology and neurological disorders community. We welcome abstracts on all aspects of neurology and neurological disorders.
              </p>
            </div>
              ...
              <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg shadow-sm">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-center gap-2">
                    ...
                    Neurology and Neurological Disorders Research
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Neurology and Neurological Disorders Applications
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Neurology and Neurological Disorders Experimental
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Neurology and Neurological Disorders Clinical
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Neurology and Neurological Disorders Policy
                  </li>
                </ul>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              We're proud to collaborate with leading neurology and neurological disorders publications and media organizations.
            </motion.p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/80 max-w-2xl mx-auto leading-relaxed">
              Subscribe to our newsletter and be the first to know about upcoming neurology and neurological disorders conferences, 
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Discover neurology and neurological disorders events worldwide</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                {isSubscribed && (
                  ...
                  >
                    <p className="text-green-300 font-medium">
                      🎉 Welcome aboard! You'll receive updates about future neurology and neurological disorders conferences.
                    </p>
                  </motion.div>
                )}
