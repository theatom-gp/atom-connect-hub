          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="mb-8">
                ...
                <p className="text-white">Conference Chair & Director of Neurology and Neurological Disorders, Portuguese National Institute of Neurology and Neurological Disorders</p>
              </div>
            </div>
          </div>
        </div>
