...
import heroBackground from '@/assets/surgeryandanesthesia/bg.jpeg';
import venueInterior from '@/assets/surgeryandanesthesia/venue-interior-1.jpg';
import venueConference from '@/assets/surgeryandanesthesia/venue-conference-room.jpg';
...
const SurgeryandAnesthesia = () => {
  ...
  const venueImages = [
    ...
    {
      src: venueExhibition,
      alt: "Surgery and Anesthesia Exhibition Hall",
  ...
  const speakers = [
    {
      ...
      title: "Chief Surgery and Anesthesia Scientist, Lisbon Crime Lab",
      country: "Portugal",
      image: speaker1,
      expertise: "Surgery and Anesthesia Analysis",
      biography: "Dr. Maria Santos is a renowned surgery and anesthesia scientist with over 20 years of experience in the field. She has worked on numerous projects related to surgery and anesthesia, including the development of new technologies and the implementation of sustainable surgery and anesthesia solutions. Dr. Santos is a member of the American Society of Surgery and Anesthesia and serves as a consultant for the International Surgery and Anesthesia Association."
    },
    {
      name: "Prof. James Wilson",
      title: "Director of Surgery and Anesthesia Research, London Metropolitan University",
      country: "United Kingdom",
      image: speaker2,
      expertise: "Digital Surgery and Anesthesia",
      biography: "Prof. James Wilson is a leading surgery and anesthesia researcher with over 15 years of experience in the field. He has published numerous papers on surgery and anesthesia, including the development of new technologies and the implementation of sustainable surgery and anesthesia solutions. Prof. Wilson is a member of the American Society of Surgery and Anesthesia and serves as a consultant for the International Surgery and Anesthesia Association."
    },
    {
      name: "Dr. Elena Rodriguez",
      title: "Senior Surgery and Anesthesia Pathologist, Madrid Institute",
      country: "Spain",
      image: speaker3,
      expertise: "Surgery and Anesthesia Pathology",
      biography: "Dr. Elena Rodriguez is a surgery and anesthesia pathologist with over 10 years of experience in the field. She has worked on numerous projects related to surgery and anesthesia, including the development of new technologies and the implementation of sustainable surgery and anesthesia solutions. Dr. Rodriguez is a member of the American Society of Surgery and Anesthesia and serves as a consultant for the International Surgery and Anesthesia Association."
    },
    {
      name: "Prof. Hans Mueller",
      title: "Head of Surgery and Anesthesia Chemistry, Berlin University",
      country: "Germany",
      image: speaker4,
      expertise: "Surgery and Anesthesia Toxicology",
      biography: "Prof. Hans Mueller is a surgery and anesthesia toxicology expert with over 10 years of experience in the field. He has published numerous papers on surgery and anesthesia toxicology, including the development of new technologies and the implementation of sustainable surgery and anesthesia solutions. Prof. Mueller is a member of the American Society of Surgery and Anesthesia and serves as a consultant for the International Surgery and Anesthesia Association."
    }
  ];
  ...
  const scheduleData = [
    {
      ...
      sessions: [
        ...
        { time: "16:15-18:00", activity: "Surgery and Anesthesia Sessions" }
      ]
    },
    {
      day: "Day 2", 
      ...
      sessions: [
        ...
        { time: "11:30-11:45", activity: "Networking Break" },
        { time: "11:45-13:45", activity: "Surgery and Anesthesia Sessions" },
        { time: "13:45-14:30", activity: "Networking Lunch Break" },
        { time: "14:30-16:30", activity: "Surgery and Anesthesia Sessions" },
        { time: "16:30-16:45", activity: "Networking Break" },
        { time: "16:45-18:30", activity: "Surgery and Anesthesia Sessions" },
    ...
    },
    {
      ...
      sessions: [
        { time: "09:00-11:30", activity: "Surgery and Anesthesia Sessions" },
        { time: "11:30-11:45", activity: "Networking Break" },
        { time: "11:45-13:45", activity: "Surgery and Anesthesia Sessions" },
        { time: "13:45-14:30", activity: "Networking Lunch Break" },
        { time: "14:30-16:30", activity: "Surgery and Anesthesia Sessions" },
  ...
  const publishingPartners = [
    { 
      name: "Surgery and Anesthesia International", 
      description: "Leading Surgery and Anesthesia Journal", 
    ...
    { 
      name: "Journal of Surgery and Anesthesia Sciences", 
      description: "Academic Surgery and Anesthesia Research", 
    ...
    { 
      name: "Surgery and Anesthesia Review", 
      description: "Surgery and Anesthesia Research Database", 
    ...
    { 
      name: "International Journal of Surgery and Anesthesia", 
      description: "Surgery and Anesthesia Research", 
  ...
  const mediaPartners = [
    { 
      name: "Surgery and Anesthesia Magazine", 
      description: "Surgery and Anesthesia News", 
    ...
    { 
      name: "Surgery and Anesthesia Investigation", 
      description: "Surgery and Anesthesia Magazine", 
    ...
    { 
      name: "Surgery and Anesthesia Today", 
      description: "Surgery and Anesthesia Research Publication", 
    ...
    { 
      name: "Surgery and Anesthesia Research Network", 
      description: "Surgery and Anesthesia Research News", 
          ...
          <div className="text-center">
            ...
            <div className="inline-block animate-[staggerUp_0.8s_ease-out_0.2s_both]">
              <div className="group relative px-8 py-4 bg-white/5 backdrop-blur-xl border border-white/10 text-white rounded-full text-sm font-medium mb-12 transition-all duration-500 hover:bg-white/10 hover:border-white/20 hover:scale-105">
                ...
                <span className="relative inline-flex items-center gap-3">
                  ...
                  <span className="tracking-wider uppercase">Surgery • Research • Anesthesia</span>
                  <div className="flex items-center gap-1">
            ...
            <div className="overflow-hidden mb-16">
              ...
              <div className="animate-[staggerUp_1s_ease-out_1s_both] mt-8">
                <p className="text-xl lg:text-xl text-white/80 font-light max-w-3xl mx-auto leading-relaxed">
                  Advancing Surgery and Anesthesia Through 
                ...
                <div className="relative overflow-hidden bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 transition-all duration-700 hover:bg-white/8 hover:border-white/20 hover:scale-105 hover:shadow-2xl hover:shadow-primary/10 p-6">
                  ...
                  <div className="relative flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xl font-semibold text-white">March 16-18, 2026</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="relative overflow-hidden bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 transition-all duration-700 hover:bg-white/8 hover:border-white/20 hover:scale-105 hover:shadow-2xl hover:shadow-secondary/10 p-6">
                  ...
                  <div className="relative flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xl font-semibold text-white">Boston, MA</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in animation-delay-1200">
              <Button 
                ...
                onClick={() => navigate('/registration?conference=surgeryandanesthesia')}
              >
              ...
              <Button 
                ...
                onClick={() => isEarlyBird && navigate('/registration?conference=surgeryandanesthesia')}
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6">
                Advancing <span className="text-primary">Surgery and Anesthesia</span> Through Research
              </h2>
              
              <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                Join the most influential surgery and anesthesia conference of 2025, where cutting-edge research meets practical applications. Connect with surgery and anesthesia experts, explore breakthrough technologies, and discover solutions that will define the future of surgery and anesthesia.
              </p>
              
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                From surgery and anesthesia research to surgery and anesthesia applications, this three-day immersive experience brings together leading surgery and anesthesia experts, researchers, and professionals from across the globe to share insights, forge partnerships, and accelerate surgery and anesthesia innovation.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <blockquote className="text-muted-foreground text-lg leading-relaxed mb-6 italic">
                "Surgery and anesthesia is the bridge between evidence and justice. The International Experts Summit on Surgery and Anesthesia 2026 represents a unique opportunity to witness the convergence of brilliant minds and revolutionary techniques in surgery and anesthesia."
              </blockquote>
              
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                As we stand at the forefront of surgery and anesthesia innovation, this conference serves as a catalyst for meaningful collaboration and groundbreaking discoveries. Join us in Boston as we explore the technologies and methodologies that will shape the future of surgery and anesthesia and create lasting impact across the surgery and anesthesia system worldwide.
              </p>
              
              <div className="mb-8">
                <p className="font-semibold text-foreground">Dr. Carlos Mendes</p>
                <p className="text-muted-foreground">Conference Chair & Director of Surgery and Anesthesia, Portuguese National Institute of Surgery and Anesthesia</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-secondary/10 rounded-lg p-8 max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Share your research and insights with the global surgery and anesthesia community. We welcome abstracts on all aspects of surgery and anesthesia.
              </p>
            </div>
              ...
              <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg shadow-sm">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-center gap-2">
                    ...
                    Surgery and Anesthesia Research
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Surgery and Anesthesia Applications
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Surgery and Anesthesia Hardware and Software
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Surgery and Anesthesia Security and Privacy
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Surgery and Anesthesia Policy and Regulation
                  </li>
                </ul>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              We're proud to collaborate with leading surgery and anesthesia publications and media organizations.
            </motion.p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/80 max-w-2xl mx-auto leading-relaxed">
              Subscribe to our newsletter and be the first to know about upcoming surgery and anesthesia conferences, 
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Discover surgery and anesthesia events worldwide</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                {isSubscribed && (
                  ...
                  >
                    <p className="text-green-300 font-medium">
                      🎉 Welcome aboard! You'll receive updates about future surgery and anesthesia conferences.
                    </p>
                  </motion.div>
                )}
...
export default SurgeryandAnesthesia;