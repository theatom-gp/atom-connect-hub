...
import heroBackground from '@/assets/techinnovationexpo/bg.jpg';
import venueInterior from '@/assets/techinnovationexpo/venue-interior-1.jpg';
import venueConference from '@/assets/techinnovationexpo/venue-conference-room.jpg';
...
const TechInnovationExpo = () => {
  ...
  const speakers = [
    {
      ...
      title: "Chief Tech Innovation Engineer, San Francisco Tech Innovation Lab",
      country: "Spain",
      image: speaker1,
      expertise: "Tech Innovation Algorithms and Applications",
      biography: "Dr. Maria Santos is a renowned tech innovation scientist with over 20 years of experience in the field. She has worked on numerous projects related to tech innovation, including the development of new technologies and the implementation of sustainable tech innovation solutions. Dr. Santos is a member of the American Society of Tech Innovation and serves as a consultant for the International Tech Innovation Association."
    },
    {
      name: "Prof. James Wilson",
      title: "Director of Tech Innovation Research, University of California, San Francisco",
      country: "United Kingdom",
      image: speaker2,
      expertise: "Tech Innovation Algorithms and Applications",
      biography: "Prof. James Wilson is a leading tech innovation researcher with over 15 years of experience in the field. He has published numerous papers on tech innovation, including the development of new technologies and the implementation of sustainable tech innovation solutions. Prof. Wilson is a member of the American Society of Tech Innovation and serves as a consultant for the International Tech Innovation Association."
    },
    {
      name: "Dr. Elena Rodriguez",
      title: "Senior Tech Innovation Engineer, San Francisco Tech Innovation Lab",
      country: "Spain",
      image: speaker3,
      expertise: "Tech Innovation Algorithms and Applications",
      biography: "Dr. Elena Rodriguez is a tech innovation scientist with over 10 years of experience in the field. She has worked on numerous projects related to tech innovation, including the development of new technologies and the implementation of sustainable tech innovation solutions. Dr. Rodriguez is a member of the American Society of Tech Innovation and serves as a consultant for the International Tech Innovation Association."
    },
    {
      name: "Prof. Hans Mueller",
      title: "Head of Tech Innovation Policy and Regulation, University of California, San Francisco",
      country: "Germany",
      image: speaker4,
      expertise: "Tech Innovation Algorithms and Applications",
      biography: "Prof. Hans Mueller is a tech innovation expert with over 10 years of experience in the field. He has published numerous papers on tech innovation, including the development of new technologies and the implementation of sustainable tech innovation solutions. Prof. Mueller is a member of the American Society of Tech Innovation and serves as a consultant for the International Tech Innovation Association."
    }
  ];
  ...
  const scheduleData = [
    {
      ...
      sessions: [
        ...
        { time: "16:15-18:00", activity: "Tech Innovation Sessions" }
      ]
    },
    {
      day: "Day 2", 
      ...
      sessions: [
        ...
        { time: "11:30-11:45", activity: "Networking Break" },
        { time: "11:45-13:45", activity: "Tech Innovation Sessions" },
        { time: "13:45-14:30", activity: "Networking Lunch Break" },
        { time: "14:30-16:30", activity: "Tech Innovation Sessions" },
        { time: "16:30-16:45", activity: "Networking Break" },
        { time: "16:45-18:30", activity: "Tech Innovation Sessions" },
    ...
    },
    {
      ...
      sessions: [
        { time: "09:00-11:30", activity: "Tech Innovation Sessions" },
        { time: "11:30-11:45", activity: "Networking Break" },
        { time: "11:45-13:45", activity: "Tech Innovation Sessions" },
        { time: "13:45-14:30", activity: "Networking Lunch Break" },
        { time: "14:30-16:30", activity: "Tech Innovation Sessions" },
  ...
  const publishingPartners = [
    { 
      name: "Tech Innovation International", 
      description: "Leading Tech Innovation Journal", 
    ...
    { 
      name: "Journal of Tech Innovation", 
      description: "Academic Tech Innovation Research", 
    ...
    { 
      name: "Tech Innovation Review", 
      description: "Tech Innovation Research Database", 
    ...
    { 
      name: "International Journal of Tech Innovation", 
      description: "Tech Innovation Research", 
  ...
  const mediaPartners = [
    { 
      name: "Tech Innovation Today", 
      description: "Tech Innovation Research Publication", 
    ...
    { 
      name: "Tech Innovation Research Network", 
      description: "Tech Innovation Research News", 
          ...
          <div className="text-center">
            ...
            <div className="inline-block animate-[staggerUp_0.8s_ease-out_0.2s_both]">
              <div className="group relative px-8 py-4 bg-white/5 backdrop-blur-xl border border-white/10 text-white rounded-full text-sm font-medium mb-12 transition-all duration-500 hover:bg-white/10 hover:border-white/20 hover:scale-105">
                ...
                <span className="relative inline-flex items-center gap-3">
                  ...
                  <span className="tracking-wider uppercase">Tech Innovation • Research • Applications</span>
                  <div className="flex items-center gap-1">
            ...
            <div className="overflow-hidden mb-16">
              ...
              <div className="animate-[staggerUp_1s_ease-out_1s_both] mt-8">
                <p className="text-xl lg:text-xl text-white/80 font-light max-w-3xl mx-auto leading-relaxed">
                  Advancing Tech Innovation and Applications Through Innovation, 
                ...
                <div className="relative overflow-hidden bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 transition-all duration-700 hover:bg-white/8 hover:border-white/20 hover:scale-105 hover:shadow-2xl hover:shadow-secondary/10 p-6">
                  ...
                  <div className="relative flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xl font-semibold text-white">Austin, TX</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in animation-delay-1200">
              <Button 
                ...
                onClick={() => navigate('/registration?conference=techinnovation')}
              >
              ...
              <Button 
                ...
                onClick={() => isEarlyBird && navigate('/registration?conference=techinnovation')}
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6">
                Advancing <span className="text-primary">Tech Innovation</span> Through Innovation and Applications
              </h2>
              
              <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                Join the most influential tech innovation conference of 2025, where cutting-edge research meets practical applications. Connect with tech innovation experts, explore breakthrough technologies, and discover solutions that will define the future of tech innovation.
              </p>
              
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                From tech innovation algorithms to tech innovation applications, this three-day immersive experience brings together leading tech innovation experts, researchers, and engineers from across the globe to share insights, forge partnerships, and accelerate tech innovation innovation.
              </p>
          ...
          <div className="bg-slate-900/10 rounded-lg p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Share your research and insights with the global tech innovation community. We welcome abstracts on all aspects of tech innovation and tech innovation applications.
              </p>
            </div>
              ...
              <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg shadow-sm">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-center gap-2">
                    ...
                    Tech Innovation Algorithms and Applications
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Tech Innovation Applications
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Tech Innovation Hardware and Software
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Tech Innovation Security and Privacy
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Tech Innovation Policy and Regulation
                  </li>
                </ul>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              We're proud to collaborate with leading tech innovation publications and media organizations.
            </motion.p>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Discover tech innovation events worldwide</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                {isSubscribed && (
                  ...
                  >
                    <p className="text-green-300 font-medium">
                      🎉 Welcome aboard! You'll receive updates about future tech innovation conferences.
                    </p>
                  </motion.div>
                )}
