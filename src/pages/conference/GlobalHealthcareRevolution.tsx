...
import heroBackground from '@/assets/globalhealthcarerevolution/bg.jpg';
import venueInterior from '@/assets/globalhealthcarerevolution/venue-interior-1.jpg';
import venueConference from '@/assets/globalhealthcarerevolution/venue-conference-room.jpg';
...
const GlobalHealthcareRevolution = () => {
  ...
  const speakers = [
    {
      ...
      title: "Chief Healthcare Engineer, San Francisco Healthcare Lab",
      country: "Spain",
      image: speaker1,
      expertise: "Healthcare Algorithms and Applications",
      biography: "Dr. Maria Santos is a renowned healthcare engineer with over 20 years of experience in the field. She has worked on numerous projects related to healthcare, including the development of new technologies and the implementation of sustainable healthcare solutions. Dr. Santos is a member of the American Society of Healthcare Engineers and serves as a consultant for the International Healthcare Association."
    },
    {
      name: "Prof. James Wilson",
      title: "Director of Healthcare Research, University of California, San Francisco",
      country: "United Kingdom",
      image: speaker2,
      expertise: "Healthcare Algorithms and Applications",
      biography: "Prof. James Wilson is a leading healthcare researcher with over 15 years of experience in the field. He has published numerous papers on healthcare, including the development of new technologies and the implementation of sustainable healthcare solutions. Prof. Wilson is a member of the American Society of Healthcare Engineers and serves as a consultant for the International Healthcare Association."
    },
    {
      name: "Dr. Elena Rodriguez",
      title: "Senior Healthcare Engineer, San Francisco Healthcare Lab",
      country: "Spain",
      image: speaker3,
      expertise: "Healthcare Algorithms and Applications",
      biography: "Dr. Elena Rodriguez is a healthcare engineer with over 10 years of experience in the field. She has worked on numerous projects related to healthcare, including the development of new technologies and the implementation of sustainable healthcare solutions. Dr. Rodriguez is a member of the American Society of Healthcare Engineers and serves as a consultant for the International Healthcare Association."
    },
    {
      name: "Prof. Hans Mueller",
      title: "Head of Healthcare Policy and Regulation, University of California, San Francisco",
      country: "Germany",
      image: speaker4,
      expertise: "Healthcare Algorithms and Applications",
      biography: "Prof. Hans Mueller is a healthcare policy and regulation expert with over 10 years of experience in the field. He has published numerous papers on healthcare policy and regulation, including the development of new policies and the implementation of sustainable healthcare solutions. Prof. Mueller is a member of the American Society of Healthcare Engineers and serves as a consultant for the International Healthcare Association."
    }
  ];
  ...
  const scheduleData = [
    {
      ...
      sessions: [
        ...
        { time: "16:15-18:00", activity: "Healthcare Sessions" }
      ]
    },
    {
      day: "Day 2", 
      ...
      sessions: [
        ...
        { time: "11:30-11:45", activity: "Networking Break" },
        { time: "11:45-13:45", activity: "Healthcare Sessions" },
        { time: "13:45-14:30", activity: "Networking Lunch Break" },
        { time: "14:30-16:30", activity: "Healthcare Sessions" },
        { time: "16:30-16:45", activity: "Networking Break" },
        { time: "16:45-18:30", activity: "Healthcare Sessions" },
    ...
    },
    {
      ...
      sessions: [
        { time: "09:00-11:30", activity: "Healthcare Sessions" },
        { time: "11:30-11:45", activity: "Networking Break" },
        { time: "11:45-13:45", activity: "Healthcare Sessions" },
        { time: "13:45-14:30", activity: "Networking Lunch Break" },
        { time: "14:30-16:30", activity: "Healthcare Sessions" },
  ...
  const publishingPartners = [
    { 
      ...
      description: "Leading Healthcare Journal", 
    ...
    { 
      name: "Journal of Healthcare", 
      description: "Academic Healthcare Research", 
    ...
    { 
      ...
      description: "Healthcare Research Database", 
    ...
    { 
      name: "International Journal of Healthcare", 
  ...
  const mediaPartners = [
    { 
      ...
      description: "Healthcare Research Publication", 
    ...
    { 
      ...
      description: "Healthcare Research News", 
  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      const subscribers = JSON.parse(localStorage.getItem('healthcareRevolutionSubscribers') || '[]');
      if (!subscribers.includes(email)) {
        subscribers.push(email);
        localStorage.setItem('healthcareRevolutionSubscribers', JSON.stringify(subscribers));
      }
            ...
            <div className="inline-block animate-[staggerUp_0.8s_ease-out_0.2s_both]">
              <div className="group relative px-8 py-4 bg-white/5 backdrop-blur-xl border border-white/10 text-white rounded-full text-sm font-medium mb-12 transition-all duration-500 hover:bg-white/10 hover:border-white/20 hover:scale-105">
                ...
                <span className="relative inline-flex items-center gap-3">
                  ...
                  <span className="tracking-wider uppercase">Healthcare • Research • Healthcare Applications</span>
                  <div className="flex items-center gap-1">
                ...
                <div className="relative overflow-hidden bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 transition-all duration-700 hover:bg-white/8 hover:border-white/20 hover:scale-105 hover:shadow-2xl hover:shadow-primary/10 p-6">
                  ...
                  <div className="relative flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xl font-semibold text-white">February 10-12, 2026</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6">
                Advancing <span className="text-primary">Healthcare</span> Through Innovation and Revolution
              </h2>
              
              <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                Join the most influential healthcare conference of 2025, where cutting-edge research meets practical applications. Connect with healthcare experts, explore breakthrough technologies, and discover solutions that will define the future of healthcare.
              </p>
              
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                From healthcare algorithms to healthcare applications, this three-day immersive experience brings together leading healthcare experts, researchers, and engineers from across the globe to share insights, forge partnerships, and accelerate healthcare innovation.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <blockquote className="text-muted-foreground text-lg leading-relaxed mb-6 italic">
                "Healthcare is the backbone of modern society. The Global Congress on Healthcare and Revolution 2025 represents a unique opportunity to witness the convergence of brilliant minds and revolutionary techniques in healthcare."
              </blockquote>
              
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                As we stand at the forefront of healthcare innovation, this conference serves as a catalyst for meaningful collaboration and groundbreaking discoveries. Join us in Boston as we explore the technologies and methodologies that will shape the future of healthcare and create lasting impact across the healthcare system worldwide.
              </p>
              
              <div className="mb-8">
                <p className="font-semibold text-foreground">Dr. Carlos Mendes</p>
                <p className="text-muted-foreground">Conference Chair & Director of Healthcare, University of California, San Francisco</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-secondary/10 rounded-lg p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Share your research and insights with the global healthcare community. We welcome abstracts on all aspects of healthcare and healthcare applications.
              </p>
            </div>
              ...
              <div className="bg-white/50 backdrop-blur-sm p-6 rounded-lg shadow-sm">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-center gap-2">
                    ...
                    Healthcare Algorithms and Applications
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                  ...
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    Healthcare Hardware and Software
                  </li>
                  <li className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              We're proud to collaborate with leading healthcare publications and media organizations.
            </motion.p>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-sm">Discover events worldwide</p>
                    </div>
                  </div>
                </div>
              </div>
