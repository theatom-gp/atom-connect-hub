  ...
  const speakers = [
    {
      ...
      biography: "Dr. Maria Santos is recognized as 'The Biomaterials Innovation Pioneer'. With over 15 years of experience in biomaterials engineering, she has developed breakthrough materials for medical implants and tissue engineering applications. Dr. Santos has published over 80 peer-reviewed papers and holds 12 patents in biomaterials technology. She has led research teams that have successfully developed biodegradable scaffolds for bone regeneration and drug-eluting stents for cardiovascular applications. Dr. Santos serves on the editorial board of the Journal of Biomaterials Science and has received the prestigious Biomaterials Innovation Award from the International Society for Biomaterials."
    },
    {
      ...
      image: speaker2,
      expertise: "Biomaterials Algorithms and Applications",
      biography: "Professor James Wilson is acclaimed as 'The Biomaterials Research Leader'. He has conducted groundbreaking research on smart biomaterials and has pioneered the development of responsive materials that adapt to physiological conditions. Professor Wilson has authored three comprehensive textbooks on biomaterials science and has trained over 300 graduate students in the field. His research on bio-inspired materials has led to the development of novel coatings for medical devices and has been instrumental in advancing the field of regenerative medicine. Professor Wilson serves on the advisory board of the National Institute of Biomedical Imaging and Bioengineering."
    },
    {
      ...
      image: speaker3,
      expertise: "Biomaterials Algorithms and Applications",
      biography: "Dr. Elena Rodriguez is distinguished as 'The Biomaterials Applications Specialist'. She has specialized in translating laboratory research into clinical applications and has successfully brought five biomaterials products to market. Dr. Rodriguez has extensive experience in regulatory affairs and has guided numerous biomaterials through FDA approval processes. She has published extensively on clinical outcomes of biomaterials applications and has been a key figure in establishing international standards for biomaterials testing. Dr. Rodriguez serves as a consultant for major medical device companies and has received the Excellence in Biomaterials Engineering award."
    },
    {
      ...
      image: speaker4,
      expertise: "Biomaterials Algorithms and Applications",
      biography: "Professor Hans Mueller is celebrated as 'The Biomaterials Policy Expert'. He has been instrumental in shaping regulatory frameworks for biomaterials worldwide and has advised government agencies in over 20 countries. Professor Mueller has developed comprehensive guidelines for biomaterials safety assessment and has been a driving force behind international harmonization of biomaterials standards. He has authored numerous policy papers and has served on expert panels for the World Health Organization and the European Medicines Agency. Professor Mueller's work has been crucial in ensuring the safe and effective use of biomaterials in clinical applications."
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="mb-8">
                ...
                <p className="text-white">Conference Chair & Director of Biomaterials, University of California, San Francisco</p>
              </div>
            </div>
          </div>
        </div>
