        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="mb-8">
                <p className="font-semibold text-secondary">Dr. Jonathan Reynolds</p>
                <p className="text-white">Conference Chair & Director of Financial Innovation, Global Finance Institute</p>
              </div>
            </div>
          </div>
        </div>
