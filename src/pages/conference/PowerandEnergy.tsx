  ...
  const speakers = [
    {
      ...
      biography: "Dr. Maria Santos is a renowned power and energy engineer with over 20 years of experience in the field. She has worked on numerous projects related to power and energy generation and distribution, including the development of new technologies and the implementation of sustainable energy solutions. Dr. Santos is a member of the American Society of Power and Energy Engineers and serves as a consultant for the International Energy Agency."
    },
    {
      ...
      biography: "Prof. James Wilson is a leading power and energy researcher with over 15 years of experience in the field. He has published numerous papers on power and energy storage and management, including the development of new technologies and the implementation of sustainable energy solutions. Prof. Wilson is a member of the American Society of Power and Energy Engineers and serves as a consultant for the International Energy Agency."
    },
    {
      ...
      biography: "Dr. Elena Rodriguez is a power and energy engineer with over 10 years of experience in the field. She has worked on numerous projects related to power and energy transmission and distribution, including the development of new technologies and the implementation of sustainable energy solutions. Dr. Rodriguez is a member of the American Society of Power and Energy Engineers and serves as a consultant for the International Energy Agency."
    },
    {
      ...
      biography: "Prof. Hans Mueller is a power and energy policy and regulation expert with over 10 years of experience in the field. He has published numerous papers on power and energy policy and regulation, including the development of new policies and the implementation of sustainable energy solutions. Prof. Mueller is a member of the American Society of Power and Energy Engineers and serves as a consultant for the International Energy Agency."
    }
  ];
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in animation-delay-1200">
              ...
              <Button 
                ...
                onClick={() => isEarlyBird && navigate('/registration?conference=powerandenergy')}
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="mb-8">
                ...
                <p className="text-white">Conference Chair & Director of Power and Energy, University of Washington</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-slate-900/10 rounded-lg p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Share your research and insights with the global power and energy community. We welcome abstracts on all aspects of power and energy and engineering.
              </p>
            </div>
